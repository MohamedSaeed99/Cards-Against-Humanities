...
io.on('connection', function (socket) {
    ...
    // socket.on("need cards", function(count){
    //     var moreCards = [];
    //     for(var i = 0; i < count; i++){
    //         moreCards.push(whitecards[Math.floor(Math.random() * whitecards.length)]);
    //     }
    //     socket.emit('cards', moreCards);
    // })
